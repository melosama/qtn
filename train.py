...
def main():
    ...
    train_dataset = GoodBad(root="E:/GoodBad/new/train/", transform=config.basic_transform)
    test_dataset = GoodBad(root="E:/GoodBad/new/test/", transform=config.basic_transform)
